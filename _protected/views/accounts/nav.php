    ...
    <div class="page-header-inner ">
        ...
        <ul class="nav navbar-nav pull-left">
            <li class="dropdown dropdown-user">
                <a href="<?=Yii::$app->homeUrl;?>expenses/index" >
                    <span class="username username-hide-on-mobile"> Expenses </span>
        ...
        <ul class="nav navbar-nav pull-left">
            <li class="dropdown dropdown-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <span class="username username-hide-on-mobile"> Banking </span>
                    <i class="fa fa-angle-down"></i>
                </a>
            </li>
        </ul>
        <ul class="nav navbar-nav pull-left">
            <li class="dropdown dropdown-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <span class="username username-hide-on-mobile"> Tax </span>
                    <i class="fa fa-angle-down"></i>
                </a>
            </li>
        </ul>
            ...
            <ul class="nav navbar-nav pull-right">
               ...
               <!--  <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <?php if(!Yii::$app->session->get('admin')):?>
                        <li>
                            <a href="<?=Yii::$app->homeUrl;?>dashboard/products">
                                <i class="icon-user"></i> Stock Catalog
                            </a>
                        </li>
                        <li>
