                                                    ...
                                                    <div class="col-md-8 col-md-offset-0">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="product-code">First Name*</label>
                                                                <input type="text" class="jina form-control" name="fname" required >
                                                            </div>
                                                            <span class="text-info" id="code-error"></span>
                                                            <div class="form-group">
                                                                <label for="product-name">Middle Name</label>
                                                                <input type="text" class="jina form-control" name="lname" >
                                                            </div>
                                                            <span class="text-info" id="name-error"></span>
                                                            <div class="form-group">
                                                                <label for="buyingPrice">Last Name*</label>
                                                                <input type="text" value="1" class="form-control" name="lname" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="sellingPrice">Middle Name</label>
                                                                <input type="text" value=" " class="form-control" name="sellingPricePerUnit" id="selling-price">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="packing">Last Name</label>
