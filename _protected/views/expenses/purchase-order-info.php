            ...
            <div class="partner-tabs" role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#tab1" aria-controls="home" role="tab" data-toggle="tab">Purchase Orders<span class="badge badge-danger"></span></a>
                    </li>
                    <li role="presentation">
                        <a href="#tab3" aria-controls="home" role="tab" data-toggle="tab">Approved Purchase Orders<span class="badge badge-danger"></span></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tab1">
                        ...
                        <br>
                        <hr class="divider">
                        <a href="<?=Yii::$app->homeUrl;?>expenses/purchase" class="text-warning"><i class="fa fa-plus"></i> New Purchase Order</a>
                        <hr class="divider">
