            ...
            <div class="partner-tabs" role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#tab1" aria-controls="home" role="tab" data-toggle="tab">Total Credit Report<span class="badge badge-danger"></span></a>
                    </li>
                    <li role="presentation">
                        <a href="#tab2" aria-controls="home" role="tab" data-toggle="tab">Credit Reports By Supplier<span class="badge badge-danger"></span></a>
                    </li>
                    <li role="presentation">
                        <a href="#tab3" aria-controls="home" role="tab" data-toggle="tab">Ageing Analysis For Creditors<span class="badge badge-danger"></span></a>
                    </li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab1">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="tab5">
                                <?php echo \app\models\ReportCreditor::buildTotalCreditorsChart(2,$start,$end,$period)?>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="tab6">
                                <?php echo \app\models\ReportCreditor::buildTotalCreditsTable(2,$start,$end,$period)?>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab2">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="tab8">
                                <?php echo \app\models\ReportCreditor::buildCreditBySupplierChart(2)?>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="tab9">
                                <?php echo \app\models\ReportCreditor::buildCreditBySupplierTable(2)?>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab3">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="tab11">
                                <?php echo \app\models\ReportCreditor::buildCreditorAgeingAnalysisChart(2)?>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="tab12">
                                <?php echo \app\models\ReportCreditor::buildAgeingAnalysisByCreditorTable(2)?>
                            </div>
